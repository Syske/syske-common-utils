...
public class AESUtil {
     ...
     * @return
     */
    public static String encryptToStr(String data, String key) throws Exception {
     ...
     * @return
     */
    public static String decryptToStr(String enCryptdata, String key) throws Exception {
