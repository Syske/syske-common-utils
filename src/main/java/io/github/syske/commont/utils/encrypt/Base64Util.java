...
public class Base64Util {
     ...
     * @throws IOException
     */
    public static String base64ToImage(String filePath, String imgBase64Str) throws IOException { // 对字节数组字符串进行Base64解码并生成图片
     ...
     * @return
     */
    public static String getImageBase64Str(String imgPath) {// 将图片文件转化为字节数组字符串，并对其进行Base64编码处理
